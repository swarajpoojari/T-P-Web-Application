...
WHERE a.CompanyName = u.CompanyName AND a.Date = u.VisitingDate
 LIMIT $start_from, $num_rec_per_page";
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <p><?php echo $row['C/P']; ?></p>
                  </td>
                  <td>
                    <p><?php echo $row['PVenue']; ?> </p>
                  </td>
                  <td>
                    <p><?php echo $row['SSLC']; ?></p>
                  </td>
                  <td>
                    <p><?php echo $row['PU/Dip']; ?> </p>
                  </td>
                  <td>
                    <p><?php echo $row['BE']; ?></p>
                  </td>
                  <td>
                    <p><?php echo $row['Backlogs']; ?></p>
                  </td>
                  <td>
                    <p><?php echo $row['HofBacklogs']; ?></p>
                  </td>
                  <td>
                    <p><?php echo $row['DetainYears']; ?></p>
                  </td>
