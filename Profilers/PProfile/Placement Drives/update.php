        ...
        <div class="row">
          <nav class="templatemo-top-nav col-lg-12 col-md-12">
            <ul class="text-uppercase">
              <li><a href="../../../Homepage/index.php">Home T&P Cell</a></li>
        ...
        <div class="templatemo-content-widget white-bg">
          ...
          <form action="updatedrive1.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
            <div class="row form-group">
              ...
              <div class="col-lg-6 col-md-6 form-group">
                <label for="DOB">Company Visiting Date</label>
              ...
              <div class="col-lg-6 col-md-6 form-group">
                <label class="control-label templatemo-block">Package</label>
                <input type="number" name="package">
              </div>
              <div class="col-lg-6 col-md-6 form-group">
                <label class="control-label templatemo-block">Date</label>
