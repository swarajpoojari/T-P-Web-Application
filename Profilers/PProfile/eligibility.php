  ...
  <div class="templatemo-flex-row">
    ...
    <div class="templatemo-content col-1 light-gray-bg">
            ...
            <table class="table table-striped table-bordered templatemo-user-table">
              <thead>
                <tr>
                  ...
                  <td><a href="" class="white-text templatemo-sort-by">SSC percentage <span class="caret"></span></a></td>
              ...
              if (isset($_POST['submit'])) {
                ...
                foreach ($branch as $key => $values) {
                  ...
                  $sql = "SELECT * FROM basicdetails where Branch='$values' and SSLC>='$sslc' and `PU/Dip`>='$puaggregate' and BE>='$beaggregate' and Backlogs<='$backlogs' and HofBacklogs<='$hisofbk' and DetainYears<='$dety' and Batch='$batch'";
                  // run the query
      ...
      <footer class="text-right">
        <p>Copyright &copy; 2023 ACPCE | Developed by
          <a href="" target="_parent">2023 A C Patil College of Engineering</a>
        </p>
      </footer>
    </div>
  </div>
