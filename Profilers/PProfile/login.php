    ...
    <div class="templatemo-sidebar">
      ...
      <nav class="templatemo-left-nav">
        <ul>
          ...
          <li><a href="..\PProfile\table48 sorce code\index.php"><i class="fa fa-home fa-fw"></i>Calendar</a></li>
      ...
      <div class="templatemo-content-container">
        <div class="templatemo-flex-row flex-content-row">
          <div class="templatemo-content-widget white-bg col-2">
            ...
            <div class="square"></div>
            <h2 class="templatemo-inline-block">Welcome to ACPCE T&P cell </h2>
            <p></p>
            <p>Hello Officer! Have a great day with us! With T&P Account, You can add drives, Send Notifications and View the Eligibility Criteria of Students.</p>
          ...
          <div class="col-1">
            <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
              ...
              <div class="panel-heading templatemo-position-relative">
                <h2 class="text-uppercase">Other PTO Details</h2>
              </div>
