...
<body>
	...
	<div style="justify-content:center;">
		...
		<div style="position: relative; bottom: 100px;  color: white; margin: 0px auto;">
			<h2>STUDENTS PLACED IN 2020-21</h2>
		</div>
	</div>
...
WHERE a.CompanyName = u.CompanyName AND a.Date = u.VisitingDate AND year(u.Date) = '2020/2021' LIMIT $start_from, $num_rec_per_page";
