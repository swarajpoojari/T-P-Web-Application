...
<html>
	<head>
		<!--favicon-->
        <link rel="shortcut icon" href="T&p.jpeg" type="image/icon">
        <link rel="icon" href="T&p.jpeg" type="image/icon">
		<title>ACPCE T&P</title>
	...
	<body>
		...
		<div class="specialty">
			...
			<div class="container">
				<div class="col-md-5 specialty-info wow fadeInLeft animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h3>Our Services</h3>
					<h5>Interactive Training and Activities </h5>
					<p>Workshops, Creativity Training and Learning Activities 
						<span></span>
					</p>
			...
			<div class="container">
				...
				<div class="testimonial-grids wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<div class="testimonial-grid">
						<p>
							<span>"</span>Knowledge is the second nature
							<span>"</span>
						</p>
					</div>
				</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h4 style="color: white">A C Patil College Of Engineering</h4>
					<h6>
		...
		<div class="copyright">
			...
			<div class="container">
              ...
              <!--<a href="http://acpce.org" target="_parent">Swaraj Poojary</a> -->
				</div>
