	...
	<div class="about-top">
		...
		<div class="container">
			<div class="about-info wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				...
				<h5>This is what tells about who we are and about A.C.Patil College Of Engineering </span></h5>
			</div>
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Our Institute is located near Kharghar, a well known place of learning. Our college is affiliated to NAAC, recognized by AICTE.Within a short span of 28 years we have made our presence felt strongly in this competitive educational sector.Our NBA Accreditation speak of our commitment to quality systems and education. 
						</p>
					</div>
				</div>
				<div class="clearfix"> </div>
		...
		<div class="container">
			...
			<div class="about-bottom-grids">
				<div class="col-md-6 about-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>What We Offer?</h4>
					<p>The Institute offers bachelors degree courses in 8 disciplines in Engineering viz. Computer Engineering, Information Technology, Electronics and  Telecommunication, Electrical, Mechanical,AI-DS,IOT and various post graduate courses . 
					</p>
				</div>
			...
			<div class="team-info">
				...
				<div class="team-grids">
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/VNPawar1.jpg" alt="">
						<h6>V.N.Pawar</h6>
						<p> Principal</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<a href= "https://www.acpce.org/our_team/mr-v-d-kulkarni/"><img src="images/VKulkarni.jpg" alt=""></a>
						<h6>Vidhyadhar Kulkarni</h6>
						<p>TPO</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/MMDeshpande.jpg" alt="">
						<h6>M.M.Despande</h6>
						<p> Computer Dept. HOD</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/SBansu.jpg" alt="">
						<h6>Shilpali Bansu</h6>
						<p>AI-DS HOD</p>
					</div>
					<div class="clearfix"> </div>
				</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="phone">
						<p> +919769111241/  022-27745722/32</p>
					</div>
				</div>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Developed by © 2023 A C Patil College of Engineering 
              <a href="http://Projectsworlds.in" target="_parent"></a>
					</p>
				</div>
